...
export const MacbookScroll = ({
  ...
  /** Optional custom ReactNode to render inside the screen instead of the static image */
  screenContent?: React.ReactNode;
  /** Optional externally controlled progress MotionValue (0-1). When supplied, internal scroll logic is bypassed. */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        externalProgress
          ? // compact layout when externally controlled (smaller overall footprint)
            "min-h-[90vh] scale-[0.55] sm:scale-[0.7] md:scale-[0.8] lg:scale-[0.85] py-10"
          : // original tall scroll space
            "min-h-[200vh] scale-[0.35] sm:scale-50 md:scale-100 md:py-80 py-0",
      )}
    >
      <motion.h2
        style={{
